                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <ul class="nav md-pills nav-justified pills-primary font-weight-bold">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabCheckoutAddons123" role="tab">2.
                                    Addons</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabCheckoutPayment123" role="tab">3.
                                    Payment</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pt-4">
                            ...
                            <div class="tab-pane fade in show active" id="tabCheckoutBilling123" role="tabpanel">
                                ...
                                <form>
                                    ...
                                    <input type="text" id="address-2" class="form-control mb-4"
                            ...
                            <div class="tab-pane fade" id="tabCheckoutAddons123" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-4">
                                        ...
                                        <img src="https://mdbootstrap.com/img/Photos/Others/images/43.jpg"
                                            class="img-fluid z-depth-1-half" alt="Second sample image">
                                    ...
                                    <div class="col-md-7 mb-4">
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, ea ut
                                            aperiam corrupti,
                                            dolorem.</p>
                                        ...
                                        <button type="button" class="btn btn-primary btn-md">Add premium support to the
                                            cart</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-4">
                                        ...
                                        <img src="https://mdbootstrap.com/img/Photos/Others/images/44.jpg"
                                            class="img-fluid z-depth-1-half" alt="Second sample image">
                                    ...
                                    <div class="col-md-7 mb-4">
                                        ...
                                        <button type="button" class="btn btn-primary btn-md">Add MDB Membership to the
                                            cart</button>
                            ...
                            <div class="tab-pane fade" id="tabCheckoutPayment123" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cc-name123" placeholder=""
                                            required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cc-cvv123" placeholder=""
                                            required>
                                        <div class="invalid-feedback">
